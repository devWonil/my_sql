...
insert into 배우정보 values (5, '공명', 1990, 183, 70, '무');
insert into 배우정보 values (6, '이동휘', 1985, 179, 72, '무');
insert into 배우정보 values (7, '하정우', 1978, 184, 75, '무');
insert into 배우정보 values (8, '주지훈', 1982, 188, 79, '무');
insert into 배우정보 values (9, '이정재', 1972, 180, 72, '무');
insert into 배우정보 values (10, '황정민', 1970, 180, 75, '김미혜');
insert into 배우정보 values (11, '김윤진', 1973, 168, 48, '박정혁');
insert into 배우정보 values (12, '오달수', 1968, 176, 68, '무');
insert into 배우정보 values (13, '로버트 다우니 주니어', 1965, 173, 68, '수전 러빈');
insert into 배우정보 values (14, '크리스 에반스', 1981, 183, 79, '무');
